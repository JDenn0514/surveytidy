...
**Then reference:** - `../surveycore/CLAUDE.md` — for surveycore
architecture (survey class structure, @data/@variables/@metadata) -
`../surveycore/plans/` — error-messages.md, formal spec, implementation
plan

...
[![CRAN
status](https://www.r-pkg.org/badges/version/surveytidy)](https://CRAN.R-project.org/package=surveytidy)
...
The most important statistical feature of surveytidy is that `filter()`

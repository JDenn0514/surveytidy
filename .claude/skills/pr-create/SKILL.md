...
> **Surveyverse projects:** Project conventions are in `.claude/rules/github-strategy.md`,
> not CLAUDE.md. Key overrides:
> - **Branch prefix**: `feature/` (not `feat/`) for new functionality
> - **PR body**: Use the "What + Checklist" template from github-strategy.md Section 7
> - **Commit format**: Conventional Commits with surveyverse scopes (`classes`, `constructors`, `metadata`, `validators`, `print`, `variance`, `conversion`)

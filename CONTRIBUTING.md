...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("JDenn0514/surveytidy", fork = TRUE)`.
...
Please note that the surveytidy project is released with a [Contributor
Code of
Conduct](https://jdenn0514.github.io/surveytidy/CODE_OF_CONDUCT.md). By

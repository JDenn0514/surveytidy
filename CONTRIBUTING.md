# Contributing to surveytidy

This outlines how to propose a change to surveytidy.

## Fixing typos

You can fix typos, spelling mistakes, or grammatical errors in the
documentation directly using the GitHub web interface, as long as the changes
are made in the _source_ file. This generally means you'll need to edit
...
*   Fork the package and clone onto your computer. If you haven't done this
    before, we recommend using `usethis::create_from_github("JDenn0514/surveytidy",
    fork = TRUE)`.
...
*   New code should follow the tidyverse [style guide](https://style.tidyverse.org).
    You can use the [air](https://posit-dev.github.io/air/) package to apply
...
Please note that the surveytidy project is released with a

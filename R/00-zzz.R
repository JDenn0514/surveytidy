...
.onLoad <- function(libname, pkgname) {
  ...
  registerS3method(
    "dplyr_reconstruct", "surveycore::survey_base",
    get("dplyr_reconstruct.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "subset", "surveycore::survey_base",
  ...
  registerS3method(
    "select", "surveycore::survey_base",
    get("select.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "relocate", "surveycore::survey_base",
    get("relocate.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "pull", "surveycore::survey_base",
    get("pull.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "glimpse", "surveycore::survey_base",
  ...
  registerS3method(
    "arrange", "surveycore::survey_base",
    get("arrange.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice", "surveycore::survey_base",
    get("slice.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice_head", "surveycore::survey_base",
    get("slice_head.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice_tail", "surveycore::survey_base",
    get("slice_tail.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice_min", "surveycore::survey_base",
    get("slice_min.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice_max", "surveycore::survey_base",
    get("slice_max.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "slice_sample", "surveycore::survey_base",
  ...
  registerS3method(
    "group_by", "surveycore::survey_base",
    get("group_by.survey_base", envir = ns),
    envir = asNamespace("dplyr")
  )

  registerS3method(
    "ungroup", "surveycore::survey_base",
  ...
  registerS3method(
    "drop_na", "surveycore::survey_base",

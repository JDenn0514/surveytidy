...
- ...:
  ...
  For `group_by()`: columns to group by. Computed expressions (e.g.,
...
[`mutate()`](https://jdenn0514.github.io/surveytidy/reference/mutate.md)
computes within groups. Future estimation functions will also use
grouping to perform stratified analysis.
